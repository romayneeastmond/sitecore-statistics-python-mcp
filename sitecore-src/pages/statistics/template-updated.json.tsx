...
import { getTemplatesUpdatedByName } from '../../services/StatisticsService';
...
export const getServerSideProps: GetServerSideProps = async ({ res, req, query }) => {
	if (res && req) {
		...
		const templatesCount = await getTemplatesUpdatedByName('/sitecore/content/company-headless-tenant/company/Data/Global/Settings/Search Helpers', templateName, language);
